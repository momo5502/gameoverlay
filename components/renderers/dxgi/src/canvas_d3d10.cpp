...
namespace gameoverlay
{
	...
	bool canvas_d3d10::create(std::string file)
	{
		...
		if (FAILED("d3dx10"_lib.invoke_pascal<HRESULT>("D3DX10CreateShaderResourceViewFromFileA", this->device, file.data(), NULL, NULL, &this->shader_resource_view, NULL)) || !this->shader_resource_view)
		{
			release_resource(this->shader_resource_view);
			return false;
		}
